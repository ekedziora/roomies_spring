...
public interface ConfirmationRepository extends JpaRepository<ExecutionConfirmation, Long> {
    ...
    List<ExecutionConfirmation> findByEventEntry_ExecutorNotAndEventEntry_Parent_MembersAndEndDateTimeGreaterThan(User executor, User member, LocalDateTime dateTime);
